...
mod:AddCallback(ModCallbacks.MC_POST_EFFECT_UPDATE, function(_, effect)
    if effect.Variant == mod.Effects.SmokescreenEffect.Var then
        mod:SmokescreenEffectAI(effect, effect:GetSprite(), effect:GetData())
    end
end)

function mod:SmokescreenEffectAI(ef, sprite, d)
