...
function mod:FloaterAI(npc, sprite, d, r)
    ...
    if d.state == "chase" then
        ...
        d.dashinit = false
        if not d.chaseinit then
            d.animinit = false
            d.chaseinit = true
        end

        --moving (hurts my eyes lol)
